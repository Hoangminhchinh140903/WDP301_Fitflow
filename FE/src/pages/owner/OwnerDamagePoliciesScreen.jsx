...
const TRIGGER_OPTIONS = [
  { value: 'Washing', label: 'Washing (đi bảo dưỡng)' },
...
export default function OwnerDamagePoliciesScreen() {
  ...
  const openCreate = () => {
    ...
    setForm({
      ...
      isActive: true,
      levels: [
        { key: 'dirty_light', label: 'Bẩn nhẹ', description: 'Vết bẩn có thể vệ sinh sạch', penaltyPercent: 5, triggerLifecycle: 'Washing', condition: 'Dirty', sortOrder: 0 },
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="VD: Chính sách mặc định cho đồ thể thao"
                  />
                </div>
                <div>
                      ...
                      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-sm"
                            placeholder="VD: Vết bẩn có thể vệ sinh sạch"
                          />
                        </div>
                      </div>
                    </div>

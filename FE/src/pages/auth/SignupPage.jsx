                ...
                <div className="auth-layout auth-layout-login">
                    ...
                    >
                        <div className="login-hero-top">
                            <img src={logoImage} alt="FITFLOW" className="login-hero-logo" />
                            <p className="auth-showcase-badge">FITFLOW - THỂ THAO THANH XUÂN</p>
                        </div>

                        <div className="login-hero-copy">
                            <h1>FITFLOW - Đồ thể thao</h1>
                            <p className="login-hero-slogan">Thuê & mua sản phẩm truyền thống - nhận nhanh tại thể thao</p>
                        </div>

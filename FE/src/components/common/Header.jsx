...
const RENT_MEGA_MENU = [
  {
    title: "Danh mục thuê",
    items: [
      { label: "Xem tất cả sản phẩm", to: "/buy?purpose=rent" },
      { label: "Vợt", to: "/buy?purpose=rent" },
    ],
  },
  {
    title: "Dịch vụ thuê",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Hướng dẫn chọn đồ", to: "/blog" },
    ],
  },
];
...
export default function Header({ active = "" }) {
  ...
  const customerNotifications = [
    ...
    { id: "n2", text: "Bạn có thể lưu sản phẩm ở mục Yêu thích để đặt nhanh." },
  ];
  ...
  return (
    <header className="site-header">
      <div className="site-shell site-top-row">
        <Link to="/" className="site-brand" aria-label="FITFLOW">
          <img src={logo} alt="FITFLOW" className="site-logo" />
        </Link>

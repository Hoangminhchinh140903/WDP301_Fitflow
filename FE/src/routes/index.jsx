...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route
        path="/owner/login"
        element={<Navigate to="/work/login?role=owner" replace />}
      />
      <Route
        path="/staff/login"
        element={<Navigate to="/work/login?role=staff" replace />}
      />
      ...
      <Route element={<PrivateRoute roles={["owner"]} />}>
        <Route path="/owner" element={<OwnerLayout />}>
          ...
          <Route
            ...
            element={<OwnerProductDetailScreen />}
          />
          <Route path="inventory" element={<InventoryDashboardPage />} />
          <Route
            path="inventory/:productId"
            element={<InventoryProductDetailPage />}
          />
          <Route
            path="inventory-dashboard"
            element={<Navigate to="/owner/inventory" replace />}
          />
          ...
          <Route
            path="damage-policies"
            element={<OwnerDamagePoliciesScreen />}
          />

    ...
    <div style="margin:0;padding:24px;background:#f8fafc;">
      <div style="max-width:680px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:24px;box-shadow:0 12px 40px rgba(15,23,42,0.08);overflow:hidden;">
        <div style="padding:28px 28px 20px;background:linear-gradient(135deg,#eff6ff,#ffffff);border-bottom:1px solid #e5e7eb;">
          <div style="font-family:Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#6366f1;">FITFLOW</div>
          ...
          <p style="margin:10px 0 0;font-family:Arial,sans-serif;font-size:14px;line-height:1.7;color:#475569;">
            Cảm ơn bạn đã đặt hàng tại FITFLOW. Đơn hàng của bạn đã được ghi nhận thành công và đang chờ xử lý.
          </p>
        </div>
    ...
    <div style="margin:0;padding:24px;background:#f8fafc;">
      <div style="max-width:680px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:24px;box-shadow:0 12px 40px rgba(15,23,42,0.08);overflow:hidden;">
        <div style="padding:28px 28px 20px;background:linear-gradient(135deg,#fdf2f8,#ffffff);border-bottom:1px solid #e5e7eb;">
          <div style="font-family:Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#db2777;">FITFLOW - THUÊ ĐỒ</div>
          ...
          <p style="margin:10px 0 0;font-family:Arial,sans-serif;font-size:14px;line-height:1.7;color:#475569;">
            Cảm ơn bạn đã đặt đơn thuê tại FITFLOW. Vui lòng hoàn tất đặt cọc để chúng tôi giữ đồ cho bạn.
          </p>
        </div>

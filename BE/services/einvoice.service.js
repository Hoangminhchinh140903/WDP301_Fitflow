...
const SELLER_NAME = process.env.EINVOICE_SELLER_NAME || 'FITFLOW – Cửa hàng thể thao FitFlow';
const SELLER_TAX_CODE = process.env.EINVOICE_SELLER_TAX_CODE || '0000000000';
const SELLER_ADDRESS = process.env.EINVOICE_SELLER_ADDRESS || 'Thanh Xuân, Hà Nội, Việt Nam';
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.fill(grayColor).font('Regular').fontSize(8)
                .text('Đây là hóa đơn điện tử được tạo tự động bởi hệ thống FITFLOW.', 50, y, { align: 'center', width: W })

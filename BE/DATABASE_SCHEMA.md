...
## Tổng quan
Dự án FitFlow sử dụng MongoDB với Mongoose ODM. Database bao gồm 17 collections để quản lý hệ thống cho thuê và bán sản phẩm.
...
### 17. FittingBooking (Đặt lịch thử vợt/sân)
- **customerId**: Tham chiếu User
- **date**: Ngày hẹn
- **timeSlot**: Khung giờ
- **note**: Ghi chú
...
```
MONGO_URI=mongodb://localhost:27017/fitflow
PORT=5000
...
## Note
Shift and ShiftRegistration collections have been removed as part of the shift removal update.
